...
public class RunStatTest {
    ...
    public void testHistoricalIsExcluded() {
        ...
        //success, but too old
        for (int i = 0; i < RunStat.MAX_LATEST_RUNS; i++) {
            occurrence.id = "id:10231,build:(id:" + 1000 + i + ")";
            occurrence.status = "SUCCESS";
            stat.addTestRunToLatest(occurrence);
        }
