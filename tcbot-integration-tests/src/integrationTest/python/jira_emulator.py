...
ISSUES = {
    ...
    "IGNITE-20007": {
        ...
        "description": "The unlucky contributor branch fails during Build stage.",
        "status": "Patch Available",
        "assignee": "unhappy-contributor",
        "labels": ["pull-request-available"],
    ...
    def do_POST(self):
        ...
        if parsed.path == "/__test__/jira/create-issue":
            ...
            issue = {
                ...
                "description": payload.get("description", payload.get("summary", "Integration test issue")),
                "status": payload.get("status", "Open"),
                "assignee": payload.get("assignee", "integration.tester"),
                "labels": payload.get("labels", []),
                "updated": payload.get("updated", "2026-05-10T10:00:00.000+0000"),
                "resolutiondate": payload.get("resolutiondate")
            }
...
def jira_issue_payload(handler, key, issue):
    return {
        ...
        "fields": {
            ...
            "labels": issue["labels"],
            "updated": issue.get("updated", "2026-05-10T10:00:00.000+0000"),
