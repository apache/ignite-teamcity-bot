...
SUITE_MODELS = [
    {
        "buildTypeId": "IgniteTests24Java17_Build",
        "tests": [],
        "duration": 12_000
    },
    {
...
def initial_builds():
    ...
    create_run_all_chain(builds, "800401", "pull/12007/head", "FAILURE", "finished",
                         queued="20260510T092000+0000", started="20260510T092010+0000",
                         finished="20260510T092110+0000",
                         suite_statuses={
                             "IgniteTests24Java17_Build": "FAILURE",
                             "IgniteTests24Java17_Cache1": "UNKNOWN",
                             "IgniteTests24Java17_ComputeGrid": "UNKNOWN",
                             "IgniteTests24Java17_Pds1": "UNKNOWN",
                             "IgniteTests24Java17_Sql": "UNKNOWN"
                         })
...
def suite_problems(suite, status, failed_tests=None):
    ...
    if suite.endswith("_Build"):
        return ["{}: Compilation failed during Build stage".format(suite)]
